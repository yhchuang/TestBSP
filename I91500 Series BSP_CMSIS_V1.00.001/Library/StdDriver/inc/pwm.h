 ...
 * $Revision: 1 $
 * $Date: 14/07/15 2:52p $
 * @brief    I91500 series PWM driver header file
 *
 * @note
...
/** @addtogroup I91500_PWM_Driver PWM Driver
  @{
*/

/** @addtogroup I91500_PWM_EXPORTED_CONSTANTS PWM Exported Constants
  @{
*/
...
#define PWM_ONE_SHOT_MODE										0x0
#define PWM_AUTO_RELOAD_MODE								0x8
/*---------------------------------------------------------------------------------------------------------*/
...
/*@}*/ /* end of group I91500_PWM_EXPORTED_CONSTANTS */


/** @addtogroup I91500_PWM_EXPORTED_FUNCTIONS PWM Exported Functions
  @{
*/
 ...
 * @return Counter value, 0~0xFFFF
 * @details This macro is used to get counter.
 */
#define PWM_GET_COUNTER(pwm) (pwm)->CNT
...
/**
 * @brief Disable output inverter of specified channel(s)
 * @param[in] pwm The base address of PWM module
 * @return None
 * @details This macro is used to enable capture input inverter
 * \hideinitializer
 */
#define PWM_DISABLE_OUTPUT_INVERTER(pwm) \
                (pwm)->CTL &= ~PWM_CTL_PINV_Msk
...
uint32_t PWM_ConfigOutputChannel_with_Mode(PWM_T *pwm,uint32_t u32Mode, uint32_t u32Frequency,uint32_t u32DutyCycle0, uint32_t u32DutyCycle1, uint32_t u32DutyCycle2, uint32_t u32DutyCycle3);
...
/*@}*/ /* end of group I91500_PWM_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group I91500_PWM_Driver */
