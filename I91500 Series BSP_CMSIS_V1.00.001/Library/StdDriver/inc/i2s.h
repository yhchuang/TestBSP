 ...
 * @brief    I91500 series I2S driver header file
 *
 * @note
...
/** @addtogroup I91500_I2S_EXPORTED_CONSTANTS I2S Exported Constants
  @{
*/
...
uint32_t I2S_Open(I2S_T *i2s, uint32_t u32MasterSlave, uint32_t u32SampleRate, uint32_t u32WordWidth, uint32_t u32Stereo, uint32_t u32DataFormat);
