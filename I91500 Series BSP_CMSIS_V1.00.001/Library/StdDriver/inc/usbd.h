/******************************************************************************
 * @file     usbd.h
 * @brief    I91500 series USB driver header file
 * $Revision  1 $
 * $Date: 20/11/24 10:26a $
 *
 * @note
...
/** @addtogroup I91500_USBD_Driver USBD Driver
  @{
*/

/** @addtogroup I91500_USBD_EXPORTED_STRUCTS USBD Exported Structs
  @{
*/
...
/*@}*/ /* end of group I91500_USBD_EXPORTED_STRUCTS */




/** @addtogroup I91500_USBD_EXPORTED_CONSTANTS USBD Exported Constants
  @{
*/
...
/*@}*/ /* end of group I91500_USBD_EXPORTED_CONSTANTS */


/** @addtogroup I91500_USBD_EXPORTED_FUNCTIONS USBD Exported Functions
  @{
*/
...
/**
  ...
  *
  * @param[in]  ep The USB endpoint ID. I91500 Series supports 12 hardware endpoint ID. This parameter could be 0 ~ 7.
  *
  * @return     None
  *
...
/**
  ...
  *
  * @param[in]  ep The USB endpoint ID. I91500 Series supports 12 endpoint ID. This parameter could be 0 ~ 7.
  *
...
/*@}*/ /* end of group I91500_USBD_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group I91500_USBD_Driver */
