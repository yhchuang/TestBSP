 ...
 * @version  V1.00
 * $Revision: 2 $
 * $Date: 20/10/27 05:00p $
 * @brief    I91500 TIMER driver header file
 *
 * @note
...
/** @addtogroup I91500_TIMER_EXPORTED_CONSTANTS TIMER Exported Constants
  @{
*/
...
/*@}*/ /* end of group I91500_TIMER_EXPORTED_CONSTANTS */
...
/**
  * @brief This macro is used to reset timer counter.
  * @param[in] timer The base address of Timer module
  *                 - \ref TIMER0
  *                 - \ref TIMER1
  *                 - \ref TIMER2
  * @note Reset Timer’s pre-scale counter, internal 16-bit up-counter and CNTEN bit.
  * \hideinitializer
  */
#define TIMER_RESET_COUNTER(timer) (((timer)->CTL) |= TMR_CTL_RSTCNT_Msk)
