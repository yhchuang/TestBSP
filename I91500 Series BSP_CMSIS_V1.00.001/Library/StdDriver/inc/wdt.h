 ...
 * $Revision: 1 $
 * $Date: 20/11/18 5:00p $
 * @brief    I91500 WDT driver header file
 *
 * @note
...
/** @addtogroup I91500_WDT_Driver WDT Driver
  @{
*/


/** @addtogroup I91500_WDT_EXPORTED_CONSTANTS WDT Exported Constants
  @{
*/
...
/*@}*/ /* end of group I91500_WDT_EXPORTED_CONSTANTS */


/** @addtogroup I91500_WDT_EXPORTED_FUNCTIONS WDT Exported Functions
  @{
*/

/**
  * @brief This macro clear WDT time-out Wake-Up flag.
  * @return None
  * \hideinitializer
  */
#define WDT_CLEAR_TIMEOUT_WAKEUP_FLAG() WDT_ClearTimeOutWakeupFlag()
...
/**
  * @brief This macro is used to reset 19-bit WDT counter.
...
/*@}*/ /* end of group I91500_WDT_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group I91500_WDT_Driver */
