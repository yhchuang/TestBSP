 ...
 * $Revision: 1 $
 * $Date: 20/11/18 7:06p $
 * @brief    I91500 BOD driver header file
 *
 * @note
...
/** @addtogroup I91500_BOD_EXPORTED_CONSTANTS BOD Exported Constants
  @{
*/
...
/*@}*/ /* end of group I91500_BOD_EXPORTED_CONSTANTS */
...
{
    return ((SYS->BODCTL & SYS_BODCTL_BODINT_Msk) ? 1 : 0 );
}
