 ...
 * $Date: 20/11/18 2:50p $
 *
 * @brief    I91500 Series UART driver header file
 *
 * @note
...
/** @addtogroup I91500_UART_EXPORTED_CONSTANTS UART Exported Constants
  @{
*/
...
/*@}*/ /* end of group I91500_UART_EXPORTED_CONSTANTS */
 ...
 *                               - UART_INTSTS_RDAINT_Msk    : Receive Data Available Interrupt Indicator to Interrupt Controller
 *                               - UART_INTSTS_THERINT_Msk   : Transmit Holding Register Empty Interrupt Indicator to Interrupt Controller
 *                               - UART_INTSTS_RLSINT_Msk    : Receive Line Status Interrupt Indicator to Interrupt Controller
 *                               - UART_INTSTS_MODEMINT_Msk  : MODEM Status Interrupt Indicator to Interrupt
 *                               - UART_INTSTS_RXTOINT_Msk   : Time Out Interrupt Indicator to Interrupt Controller
 *                               - UART_INTSTS_BUFERRINT_Msk : Buffer Error Interrupt Indicator to Interrupt Controller
 *    @return
 ...
 *
 *    @param    uart    		The base address of UART module
 *    @param    u32TrigLevel    The level of receive fifo trigger
 *                              (UART_FIFO_RFITL_1BYTE/UART_FIFO_RFITL_4BYTE)
 *    @return   None
 */
__STATIC_INLINE void UART_SET_FIFO_TRIGGER_LEVEL(UART_T* uart,uint32_t u32TrigLevel)    
{
	uart->FIFO = ((uart->FIFO)&~UART_FIFO_RFITL_Msk)|u32TrigLevel;
}
