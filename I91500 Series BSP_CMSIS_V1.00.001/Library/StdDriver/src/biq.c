 ...
 * @brief    I91500 BIQ driver source file
 *
 * @note
...
void BIQ_SetCoeff(uint32_t u32BiqCoeff[30])
{
    ...
    /* The default coefficients will be downloaded to the coefficieBIQ_CTL_STAGE_Msknt ram automatically in 32 internal system clocks.*/
