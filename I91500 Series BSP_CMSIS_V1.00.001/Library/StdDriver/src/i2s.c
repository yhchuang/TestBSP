 ...
 * @version  V3.00
 * $Revision: 11 $
 * $Date: 20/11/24 04:26p $
 * @brief    I91500 series I2S driver source file
 *
 * @note
...
/** @addtogroup I91500_I2S_Driver I2S Driver
  @{
*/

/** @addtogroup I91500_I2S_EXPORTED_FUNCTIONS I2S Exported Functions
  @{
*/
...
static uint32_t I2S_GetSourceClockFreq(I2S_T *i2s)
{
	...
	if((CLK->CLKSEL1 & CLK_CLKSEL1_I2S0SEL_Msk) == CLK_CLKSEL1_I2S0SEL_HXT)
	{
		/* Clock source is HXT */
		u32Freq = __HXT; 
	}
	else if((CLK->CLKSEL1 & CLK_CLKSEL1_I2S0SEL_Msk) == CLK_CLKSEL1_I2S0SEL_PLLFOUT)
	{
		/* Clock source is PLL */
		u32Freq = CLK_GetPLLFreq(); 
	}
	else if((CLK->CLKSEL1 & CLK_CLKSEL1_I2S0SEL_Msk) == CLK_CLKSEL1_I2S0SEL_HIRC)
	{
		/* Clock source is HIRC */
		u32Freq = g_u32HIRC; 
	}
	else if((CLK->CLKSEL1 & CLK_CLKSEL1_I2S0SEL_Msk) == CLK_CLKSEL1_I2S0SEL_MCLKI)
	{
		/* Clock source is MCLKI */
		u32Freq = CLK_GetMCLKIFrequency(); 
	}
	else if((CLK->CLKSEL1 & CLK_CLKSEL1_I2S0SEL_Msk) == CLK_CLKSEL1_I2S0SEL_XLCK)
	{
		/* Clock source is XCLK */
		u32Freq = CLK_GetXCLKFrequency(); 
	}
	else
	{
...
{
    uint32_t u32Divider, u32Channels;
...
/*@}*/ /* end of group I91500_I2S_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group I91500_I2S_Driver */
