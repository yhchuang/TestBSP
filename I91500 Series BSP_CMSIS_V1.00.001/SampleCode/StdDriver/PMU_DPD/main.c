 ...
 * @version  V1.00
 * @brief
 *       Show Deep Power Down Mode and Wake-up Methods.
 *
...
int main(void)
{
    ...
    {
        printf("\n+-----------------------------------------------------------------------------+\n");
        printf("|              PMU Demo Sample(Deep Power Down Mode)                          |\n");
        printf("+-----------------------------------------------------------------------------+\n");
        ...
        WDT_DisableInt();
			...
			printf("+-----------------------------------------------------------------------------+\n");
        printf("| Please select 'Deep Power Down Mode' wake-up source.                        |\n");
        printf("+-----------------------------------------------------------------------------+\n");
			  printf("| 1.PA15 wakeup pin.                                                          |\n");
			  printf("| 2.OSC10K Timer(Set 6 sec).                                                  |\n");
				printf("+-----------------------------------------------------------------------------+\n");
        DPD_wk_src = getchar();
			
		
		printf("+-----------------------------------------------------------------------------+\n");
        printf("| Please press 'Enter' into 'Deep Power Down Mode' and wake-up from GPIO Pin. |\n");
        printf("+-----------------------------------------------------------------------------+\n");
        getchar();

		printf("Enter to Deep Power Down Mode......\n");
		
		switch(DPD_wk_src)
		{
			case'1':
				CLK_DeepPowerDown(CLK_DPDWAKEUP_PIN,CLK_DPDWAKETIME_100ms);
			  printf("Trigger PA15 low to wakeup from Deep Power Down mode......\n");
			break;
			
			case'2':
				CLK_DeepPowerDown(CLK_DPDWAKEUP_OSC10K,CLK_DPDWAKETIME_65000ms);
			  printf("Wait around 6 seconds for 10k timer to wakeup from Deep Power Down mode......\n");
			  printf("CLK->PWRCTL= 0x%X\n" ,CLK->PWRCTL);
			break;
