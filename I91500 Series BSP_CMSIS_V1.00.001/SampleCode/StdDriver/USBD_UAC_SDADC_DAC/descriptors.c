...
const uint8_t gu8ConfigDescriptor[] = 
{
...
#if (REC_CHANNELS == 1)
#if __FEEDBACK__
    WBVAL(233),                         /* wTotalLength */
#else
    WBVAL(224),                         /* wTotalLength */
#endif 
#elif (REC_CHANNELS == 2)
#if __FEEDBACK__
    WBVAL(234),                         /* wTotalLength */
#else
    WBVAL(225),                         /* wTotalLength */
#endif      
#endif
    0x04,                               /* bNumInterfaces */
    ...
    0x02,                               /* bSamFreqType */
    B3VAL(SAMPLE_RATE_16K),             /* tSamFreq[1] */
    B3VAL(SAMPLE_RATE_48K),             /* tSamFreq[2] */
